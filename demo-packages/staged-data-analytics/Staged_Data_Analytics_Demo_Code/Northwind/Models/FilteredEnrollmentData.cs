...
{
    public class FilteredEnrollmentData
    {
        ...
        public static FilteredEnrollmentData GetFilteredEnrollmentData(InsuranceContext _context, int enrollmentID)
        {
            /*
                SELECT *
            ...
            */
            ...
            var enrollments = (from e in _context.Enrollments
                               ...
                               select new FilteredEnrollmentData
                               {
